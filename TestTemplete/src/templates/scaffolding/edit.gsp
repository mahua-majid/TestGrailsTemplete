...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <!-- flash message end -->
            ...
            <g:form url="[resource: ${propertyName}, action: 'update']" method="post"
                    class="form-horizontal" <%=multiPart ? ' enctype="multipart/form-data"' : '' %>>
            <div style="width: 90%;margin-left: 4%; margin-top: 2%;">
                ...
                %{--<sec:access url="/${className}/clone/\${${propertyName}.id}">
                                    <g:link action="clone" id="\${${propertyName}?.id}" class="btn btn-adn btn-sm"><i
                                     class="fa fa-clone"></i>Clone</g:link>
                                </sec:access>--}%
                %{--<sec:access url="/${className}/delete/\${${propertyName}.id}">--}%
                    <g:link action="delete" id="\${${propertyName}.id}" class="btn btn-danger btn-sm"><i
