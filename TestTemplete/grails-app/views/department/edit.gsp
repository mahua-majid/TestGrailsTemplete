...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <!-- flash message end -->
            ...
            <g:form url="[resource: departmentInstance, action: 'update']" method="post"
            ...
            <div style="width: 90%;margin-left: 4%; margin-top: 2%;">
                ...
                %{--<sec:access url="/Department/clone/${departmentInstance.id}">
                                    <g:link action="clone" id="${departmentInstance?.id}" class="btn btn-adn btn-sm"><i
                                     class="fa fa-clone"></i>Clone</g:link>
                                </sec:access>--}%
                %{--<sec:access url="/Department/delete/${departmentInstance.id}">--}%
                    <g:link action="delete" id="${departmentInstance.id}" class="btn btn-danger btn-sm"><i
