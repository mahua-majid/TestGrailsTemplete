...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <!-- flash message end -->
            ...
            <g:form url="[resource: courseInstance, action: 'update']" method="post"
            ...
            <div style="width: 90%;margin-left: 4%; margin-top: 2%;">
                ...
                %{--<sec:access url="/Course/clone/${courseInstance.id}">
                                    <g:link action="clone" id="${courseInstance?.id}" class="btn btn-adn btn-sm"><i
                                     class="fa fa-clone"></i>Clone</g:link>
                                </sec:access>--}%
                %{--<sec:access url="/Course/delete/${courseInstance.id}">--}%
                    <g:link action="delete" id="${courseInstance.id}" class="btn btn-danger btn-sm"><i
